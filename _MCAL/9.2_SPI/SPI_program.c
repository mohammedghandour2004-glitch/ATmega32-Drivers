...
#include "../../_MCAL/9.2_SPI/SPI_config.h"
#include "../../_MCAL/9.2_SPI/SPI_interface.h"
#include "../../_MCAL/9.2_SPI/SPI_private.h"
...
u8 SPI_u8Tranceive (u8 Copy_u8TData , u8 * Copy_u8RData)
{
	...
	if (SPI_u8State == IDLE)
	{
		...
		while (((GET_BIT(SPSR , SPSR_SPIF)) == 0) && (Local_u32TimeoutCounter < SPI_uint32TIMEOUT))
		{
			Local_u32TimeoutCounter++ ;
		}
		if (Local_u32TimeoutCounter == SPI_uint32TIMEOUT)
		{
