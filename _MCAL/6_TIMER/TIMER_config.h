...
#ifndef _MCAL_6_TIMER_TIMER_CONFIG_H_
#define _MCAL_6_TIMER_TIMER_CONFIG_H_
...
/***********************************************************************************************/
	...
	/*Set Input Capture Value (used as TOP for ICR1-based PWM modes)*/
...
/***********************************************************************************************/
	...
	/*Set the Required Prescaler
	 * Choose between (Timer2 prescaler options differ from Timer0/Timer1 on ATmega32)
...
#endif /* _MCAL_6_TIMER_TIMER_CONFIG_H_ */
